...
public class LauncherProvider extends ContentProvider {
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper implements LayoutParserCallback {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            // This was the old L2-based SudaLauncher's version. Do steps that come after version 12 
            ...
            if (version == 16) {
                Log.w(TAG, "Found pre-11 SudaLauncher preparing update");
            ...
            if (oldVersion < 21) {
                ...
                // we can upgrade from SudaLuncher and from Launcher3(new)
                Cursor c = null;
                try {
